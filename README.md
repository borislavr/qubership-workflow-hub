...
jobs:
  cla_assistant:
    uses: netcracker/qubership-workflow-hub/.github/workflows/cla.yaml@v0.0.5
    secrets:
...
jobs:
  call-prettier-fix:
    uses: netcracker/qubership-workflow-hub/.github/workflows/prettierFix.yaml@v0.0.5
```
...
jobs:
  call-apply-filter:
    uses: netcracker/qubership-workflow-hub/.github/workflows/profanityFilter.yaml@v0.0.5
```
