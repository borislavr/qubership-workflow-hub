...
jobs:
  cla_assistant:
    uses: netcracker/qubership-workflow-hub/.github/workflows/cla.yaml@v2.0.0
    secrets:
...
jobs:
  call-prettier-fix:
    uses: netcracker/qubership-workflow-hub/.github/workflows/prettierFix.yaml@v2.0.0
```
...
jobs:
  call-apply-filter:
    uses: netcracker/qubership-workflow-hub/.github/workflows/profanityFilter.yaml@v2.0.0
```
